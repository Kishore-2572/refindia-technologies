...
const HomeServices = () => {
  ...
  return (
    <Container>
      <div className="homeservices-heading">
        <h2 className="mt-5">
          <span style={{ color: 'blue' }}>OUR </span> SERVICES
        </h2>
      </div>
      ...
      <Row>
        <Col xs={12} md={6}>
          ...
          >
            <Image
              src="https://img.freepik.com/free-vector/factory-workers-robotic-arm-removing-packages-from-conveyor-line-engineer-using-computer-operating-process-vector-illustration-business-production-machine-technology-concepts_74855-9859.jpg?w=900&t=st=1679826013~exp=1679826613~hmac=127e2aa0cedccace7d74718110d149cbef270c427c8821549a65452c942af6eb"
              alt="about us"
              fluid
            />
          </div>
        ...
        <Col xs={12} md={6}>
          <p data-aos="fade-left" data-aos-delay="100" data-aos-duration="1000">
            ...
            in Namakkal, Tamil Nadu. The products we offer to our customers are
            Milk Condensing Machine, Curd Making Plant and many more.
            <p>
              <br /> The array of our products is developed with the most
